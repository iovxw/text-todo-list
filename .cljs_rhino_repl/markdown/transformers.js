...
var and__26454__auto__ = cljs.core.not_empty.call(null,trimmed);
...
if(cljs.core.truth_((function (){var or__26466__auto__ = new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(state);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(cljs.core.truth_((function (){var or__26466__auto__ = markdown.transformers.h1_QMARK_.call(null,text);
if(cljs.core.truth_(or__26466__auto__)){
return or__26466__auto__;
} else {
...
var G__28298 = cljs.core.into.call(null,buf,cljs.core.concat.call(null,cljs.core.seq.call(null,"<sup>"),cljs.core.second.call(null,remaining),cljs.core.seq.call(null,"</sup>")));
var G__28299 = cljs.core.drop.call(null,(2),remaining);
buf = G__28298;
remaining = G__28299;
continue;
} else {
var G__28300 = cljs.core.into.call(null,buf,cljs.core.first.call(null,remaining));
var G__28301 = cljs.core.rest.call(null,remaining);
buf = G__28300;
remaining = G__28301;
continue;
...
if(cljs.core.truth_((function (){var or__26466__auto__ = new cljs.core.Keyword(null,"codeblock","codeblock",-851153855).cljs$core$IFn$_invoke$arity$1(state);
if(cljs.core.truth_(or__26466__auto__)){
return or__26466__auto__;
} else {
...
markdown.transformers.br = (function markdown$transformers$br(text,p__28302){
var map__28305 = p__28302;
...
var state = map__28305__$1;
var code = cljs.core.get.call(null,map__28305__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var lists = cljs.core.get.call(null,map__28305__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((cljs.core._EQ_.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [" "," "], null),cljs.core.take_last.call(null,(2),text))) && (cljs.core.not.call(null,(function (){var or__26466__auto__ = code;
if(cljs.core.truth_(or__26466__auto__)){
return or__26466__auto__;
} else {
return lists;
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(cljs.core.truth_(new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(state))?text:clojure.string.replace.call(null,text,/<https?:\/\/[-A-Za-z0-9+&@#\/%?=~_()|!:,.;]*[-A-Za-z0-9+&@#\/%=~_()|]>/,(function (p1__28307_SHARP_){
var url = cljs.core.subs.call(null,p1__28307_SHARP_,(1),(cljs.core.count.call(null,p1__28307_SHARP_) - (1)));
...
})())?text:clojure.string.replace.call(null,text,/<[\w._%+-]+@[\w.-]+\.[\w]{2,4}>/,(function (p1__28308_SHARP_){
var encoded = (cljs.core.truth_(new cljs.core.Keyword(null,"clojurescript","clojurescript",-299769403).cljs$core$IFn$_invoke$arity$1(state))?cljs.core.subs.call(null,p1__28308_SHARP_,(1),(cljs.core.count.call(null,p1__28308_SHARP_) - (1))):cljs.core.apply.call(null,cljs.core.str,cljs.core.map.call(null,(function (c){
if((cljs.core.rand.call(null) > 0.5)){
return markdown.transformers.formatter.call(null,"&#x%02x;",(c | (0)));
} else {
return c;
}
}),cljs.core.subs.call(null,p1__28308_SHARP_,(1),(cljs.core.count.call(null,p1__28308_SHARP_) - (1))))));
...
if(cljs.core.truth_((function (){var and__26454__auto__ = cljs.core.not.call(null,last_line_empty_QMARK_);
if(and__26454__auto__){
...
markdown.transformers.paragraph = (function markdown$transformers$paragraph(text,p__28309){
...
var state = map__28312__$1;
var eof = cljs.core.get.call(null,map__28312__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var heading = cljs.core.get.call(null,map__28312__$1,new cljs.core.Keyword(null,"heading","heading",-1312171873));
var hr = cljs.core.get.call(null,map__28312__$1,new cljs.core.Keyword(null,"hr","hr",1377740067));
var code = cljs.core.get.call(null,map__28312__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var lists = cljs.core.get.call(null,map__28312__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var blockquote = cljs.core.get.call(null,map__28312__$1,new cljs.core.Keyword(null,"blockquote","blockquote",372264190));
var paragraph__$1 = cljs.core.get.call(null,map__28312__$1,new cljs.core.Keyword(null,"paragraph","paragraph",296707709));
var last_line_empty_QMARK_ = cljs.core.get.call(null,map__28312__$1,new cljs.core.Keyword(null,"last-line-empty?","last-line-empty?",1279111527));
if(cljs.core.truth_((function (){var and__26454__auto__ = paragraph__$1;
if(cljs.core.truth_(and__26454__auto__)){
return lists;
} else {
return and__26454__auto__;
...
if(cljs.core.truth_((function (){var or__26466__auto__ = heading;
if(cljs.core.truth_(or__26466__auto__)){
return or__26466__auto__;
} else {
var or__26466__auto____$1 = hr;
if(cljs.core.truth_(or__26466__auto____$1)){
return or__26466__auto____$1;
} else {
var or__26466__auto____$2 = code;
if(cljs.core.truth_(or__26466__auto____$2)){
return or__26466__auto____$2;
} else {
var or__26466__auto____$3 = lists;
if(cljs.core.truth_(or__26466__auto____$3)){
return or__26466__auto____$3;
} else {
return blockquote;
}
}
...
if(cljs.core.truth_((function (){var or__26466__auto__ = eof;
if(cljs.core.truth_(or__26466__auto__)){
return or__26466__auto__;
} else {
...
if(cljs.core.truth_((function (){var and__26454__auto__ = cljs.core.not.call(null,eof);
if(and__26454__auto__){
...
markdown.transformers.code = (function markdown$transformers$code(text,p__28314){
var map__28317 = p__28314;
...
var state = map__28317__$1;
var eof = cljs.core.get.call(null,map__28317__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var lists = cljs.core.get.call(null,map__28317__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var code__$1 = cljs.core.get.call(null,map__28317__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.call(null,map__28317__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
if(cljs.core.truth_((function (){var or__26466__auto__ = lists;
if(cljs.core.truth_(or__26466__auto__)){
return or__26466__auto__;
} else {
return codeblock;
...
if(cljs.core.truth_((function (){var and__26454__auto__ = cljs.core._EQ_.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["`","`","`"], null),cljs.core.take.call(null,(3),trimmed));
if(and__26454__auto__){
return new cljs.core.Keyword(null,"codeblock","codeblock",-851153855).cljs$core$IFn$_invoke$arity$1(state);
} else {
return and__26454__auto__;
...
if(cljs.core.truth_((function (){var and__26454__auto__ = cljs.core._EQ_.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["`","`","`"], null),cljs.core.take_last.call(null,(3),trimmed));
if(and__26454__auto__){
return new cljs.core.Keyword(null,"codeblock","codeblock",-851153855).cljs$core$IFn$_invoke$arity$1(state);
} else {
return and__26454__auto__;
...
var vec__28320 = cljs.core.split_with.call(null,cljs.core.partial.call(null,cljs.core.not_EQ_," "),cljs.core.drop.call(null,(3),trimmed));
var lang = cljs.core.nth.call(null,vec__28320,(0),null);
var code = cljs.core.nth.call(null,vec__28320,(1),null);
...
markdown.transformers.blockquote = (function markdown$transformers$blockquote(text,p__28321){
...
var state = map__28324__$1;
var eof = cljs.core.get.call(null,map__28324__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var code = cljs.core.get.call(null,map__28324__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.call(null,map__28324__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var lists = cljs.core.get.call(null,map__28324__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var trimmed = clojure.string.trim.call(null,text);
if(cljs.core.truth_((function (){var or__26466__auto__ = code;
if(cljs.core.truth_(or__26466__auto__)){
return or__26466__auto__;
} else {
var or__26466__auto____$1 = codeblock;
if(cljs.core.truth_(or__26466__auto____$1)){
return or__26466__auto____$1;
} else {
return lists;
...
return [cljs.core.str("<ol class='footnotes'>"),cljs.core.str(p1__28326_SHARP_),cljs.core.str("</ol>")].join('');
}).call(null,cljs.core.reduce.call(null,(function (footnotes__$1,p__28329){
var vec__28330 = p__28329;
var id = cljs.core.nth.call(null,vec__28330,(0),null);
var label = cljs.core.nth.call(null,vec__28330,(1),null);
...
var vec__28333 = cljs.core.re_matches.call(null,/^([0-9A-Za-z_-]*):(.*)$/,line);
var _ = cljs.core.nth.call(null,vec__28333,(0),null);
var key = cljs.core.nth.call(null,vec__28333,(1),null);
var val = cljs.core.nth.call(null,vec__28333,(2),null);
var vec__28334 = cljs.core.re_matches.call(null,/^    (.*)$/,line);
var ___$1 = cljs.core.nth.call(null,vec__28334,(0),null);
var next_val = cljs.core.nth.call(null,vec__28334,(1),null);
...
var vec__28336 = ((cljs.core.sequential_QMARK_.call(null,data))?data:new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [prev_key,data], null));
var key = cljs.core.nth.call(null,vec__28336,(0),null);
var val = cljs.core.nth.call(null,vec__28336,(1),null);
...
var G__28337 = cljs.core.merge.call(null,acc,cljs.core.PersistentArrayMap.fromArray([key,new_val], true, false));
var G__28338 = cljs.core.rest.call(null,remain);
var G__28339 = key;
acc = G__28337;
remain = G__28338;
prev_key = G__28339;
