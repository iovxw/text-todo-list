...
return clojure.string.join.call(null,(function (){var iter__27238__auto__ = (function markdown$lists$close_lists_$_iter__28350(s__28351){
...
var c__27236__auto__ = cljs.core.chunk_first.call(null,s__28351__$2);
var size__27237__auto__ = cljs.core.count.call(null,c__27236__auto__);
var b__28353 = cljs.core.chunk_buffer.call(null,size__27237__auto__);
if((function (){var i__28352 = (0);
while(true){
if((i__28352 < size__27237__auto__)){
var vec__28356 = cljs.core._nth.call(null,c__27236__auto__,i__28352);
var list_type = cljs.core.nth.call(null,vec__28356,(0),null);
cljs.core.chunk_append.call(null,b__28353,[cljs.core.str("</li></"),cljs.core.str(cljs.core.name.call(null,list_type)),cljs.core.str(">")].join(''));

var G__28358 = (i__28352 + (1));
i__28352 = G__28358;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__28353),markdown$lists$close_lists_$_iter__28350.call(null,cljs.core.chunk_rest.call(null,s__28351__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__28353),null);
}
} else {
var vec__28357 = cljs.core.first.call(null,s__28351__$2);
var list_type = cljs.core.nth.call(null,vec__28357,(0),null);
return cljs.core.cons.call(null,[cljs.core.str("</li></"),cljs.core.str(cljs.core.name.call(null,list_type)),cljs.core.str(">")].join(''),markdown$lists$close_lists_$_iter__28350.call(null,cljs.core.rest.call(null,s__28351__$2)));
}
} else {
return null;
}
...
return iter__27238__auto__.call(null,lists);
})());
});
...
var lists_to_close = cljs.core.take_while.call(null,(function (p1__28359_SHARP_){
return (cljs.core.second.call(null,p1__28359_SHARP_) > num_indents);
...
var vec__28361 = cljs.core.last.call(null,new cljs.core.Keyword(null,"lists","lists",-884730684).cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.call(null,vec__28361,(0),null);
var indents = cljs.core.nth.call(null,vec__28361,(1),null);
...
return markdown.lists.add_row.call(null,new cljs.core.Keyword(null,"ul","ul",-1349521403),list_type,num_indents,indents,(function (){var or__26466__auto__ = markdown.common.make_heading.call(null,content,false);
...
var vec__28363 = cljs.core.last.call(null,new cljs.core.Keyword(null,"lists","lists",-884730684).cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.call(null,vec__28363,(0),null);
var indents = cljs.core.nth.call(null,vec__28363,(1),null);
var num_indents = cljs.core.count.call(null,cljs.core.take_while.call(null,cljs.core.partial.call(null,cljs.core._EQ_," "),text));
...
return markdown.lists.add_row.call(null,new cljs.core.Keyword(null,"ol","ol",932524051),list_type,num_indents,indents,(function (){var or__26466__auto__ = markdown.common.make_heading.call(null,content,false);
if(cljs.core.truth_(or__26466__auto__)){
return or__26466__auto__;
} else {
return content;
...
markdown.lists.li = (function markdown$lists$li(text,p__28364){
var map__28367 = p__28364;
...
var code = cljs.core.get.call(null,map__28367__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.call(null,map__28367__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var last_line_empty_QMARK_ = cljs.core.get.call(null,map__28367__$1,new cljs.core.Keyword(null,"last-line-empty?","last-line-empty?",1279111527));
var eof = cljs.core.get.call(null,map__28367__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var lists = cljs.core.get.call(null,map__28367__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
if(cljs.core.truth_((function (){var and__26454__auto__ = last_line_empty_QMARK_;
...
if(cljs.core.truth_((function (){var and__26454__auto__ = lists;
if(cljs.core.truth_(and__26454__auto__)){
var or__26466__auto__ = last_line_empty_QMARK_;
if(cljs.core.truth_(or__26466__auto__)){
return or__26466__auto__;
} else {
return eof;
...
var and__26454__auto____$1 = lists;
if(cljs.core.truth_(and__26454__auto____$1)){
return clojure.string.blank_QMARK_.call(null,text);
} else {
return and__26454__auto____$1;
}
} else {
return and__26454__auto__;
}
...
if(cljs.core.truth_((function (){var and__26454__auto__ = (function (){var or__26466__auto__ = eof;
if(cljs.core.truth_(or__26466__auto__)){
return or__26466__auto__;
} else {
